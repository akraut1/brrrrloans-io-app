...
drop policy "Organization admins can delete organizations" on "public"."auth_clerk_orgs";

drop policy "Organization admins can insert organizations" on "public"."auth_clerk_orgs";

drop policy "Organization admins can update organizations" on "public"."auth_clerk_orgs";

drop policy "Organization members can view organizations" on "public"."auth_clerk_orgs";

drop policy "Service role can delete organizations" on "public"."auth_clerk_orgs";

drop policy "Service role can insert organizations" on "public"."auth_clerk_orgs";

drop policy "Service role can select organizations" on "public"."auth_clerk_orgs";

drop policy "Service role can update organizations" on "public"."auth_clerk_orgs";

drop policy "Organization admins can delete members" on "public"."auth_clerk_orgs_members";

drop policy "Organization admins can insert members" on "public"."auth_clerk_orgs_members";

drop policy "Organization admins can update members" on "public"."auth_clerk_orgs_members";

drop policy "Organization members can view other members" on "public"."auth_clerk_orgs_members";

drop policy "Service role can delete members" on "public"."auth_clerk_orgs_members";

drop policy "Service role can insert members" on "public"."auth_clerk_orgs_members";

drop policy "Service role can select members" on "public"."auth_clerk_orgs_members";

drop policy "Service role can update members" on "public"."auth_clerk_orgs_members";

alter table "public"."auth_clerk_orgs" drop constraint "auth_clerk_orgs_clerk_organization_slug_key";

alter table "public"."auth_clerk_orgs_members" drop constraint "auth_clerk_orgs_members_clerk_role_check";

alter table "public"."auth_clerk_orgs_members" drop constraint "auth_clerk_orgs_members_user_id_fkey";

alter table "public"."auth_clerk_orgs_members" drop constraint "auth_clerk_orgs_members_pkey";

alter table "public"."auth_user_profiles" add column "full_name" text generated always as (TRIM(BOTH FROM ((COALESCE(first_name, ''::text) || ' '::text) || COALESCE(last_name, ''::text)))) stored;

alter table "public"."auth_user_profiles" alter column "email" set data type character varying(255) using "email"::character varying(255);

alter table "public"."auth_user_profiles" alter column "id" add generated by default as identity;

alter table "public"."auth_user_profiles" alter column "is_internal_yn" set default false;

alter table "public"."auth_user_profiles" alter column "is_internal_yn" set not null;

alter table "public"."auth_user_profiles" alter column "updated_at" set default (now() AT TIME ZONE 'utc'::text);
