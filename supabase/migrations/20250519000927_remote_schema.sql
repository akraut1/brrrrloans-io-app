...
-- Skipping problematic country enum creation due to syntax errors with special characters
-- create type "public"."country_enum" as enum ('United States', 'Canada', 'United Kingdom', 'Other');
