    ...
    Tables: {
      ...
      user_clerk_orgs: {
        Row: {
          ...
          clerk_organization_slug: string
          created_at: string
      ...
      user_clerk_orgs_members: {
        Row: {
          clerk_id: string
          clerk_organization_fkey: number | null
          clerk_organization_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "user_clerk_orgs_members_clerk_organization_fkey_fkey"
            columns: ["clerk_organization_fkey"]
            isOneToOne: false
            referencedRelation: "user_clerk_orgs"
            referencedColumns: ["id"]
          },
          {
