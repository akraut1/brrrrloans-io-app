  ...
  public: {
    Tables: {
      ...
      bs_investor_deals: {
        ...
        Relationships: [
          {
            foreignKeyName: "bs_investor_deals_contact_id_fkey";
            columns: ["contact_id"];
            isOneToOne: false;
            referencedRelation: "contact";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "bs_investor_deals_contact_types_id_fkey";
          ...
          {
            foreignKeyName: "bs_investor_deals_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: false;
            referencedRelation: "deal";
            referencedColumns: ["id"];
      ...
      bs_investor_distributions: {
        ...
        Relationships: [
          {
            foreignKeyName: "bs_investor_distribution_details_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: false;
            referencedRelation: "deal";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "bs_investor_distributions_instrument_id_fkey";
            columns: ["instrument_id"];
            isOneToOne: false;
            referencedRelation: "bs_debt_instruments";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "bs_investor_distributions_investor_id_fkey";
            columns: ["investor_id"];
            isOneToOne: false;
            referencedRelation: "contact";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "bs_investor_distributions_statement_id_fkey";
            columns: ["statement_id"];
            isOneToOne: false;
            referencedRelation: "bs_investor_statements";
            referencedColumns: ["id"];
          }
        ];
      };
      bs_investor_statements: {
        ...
        Relationships: [
          {
            foreignKeyName: "bs_investor_statements_investor_id_fkey";
            columns: ["investor_id"];
            isOneToOne: false;
            referencedRelation: "contact";
            referencedColumns: ["id"];
      ...
      bs_investor_transactions: {
        Row: {
          ...
          reference_type:
            | Database["public"]["Enums"]["reference_type_enum"]
            | null;
        ...
        Relationships: [
          {
            foreignKeyName: "bs_investor_distribution_payments_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: false;
            referencedRelation: "deal";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "bs_investor_transactions_instrument_id_fkey";
            columns: ["instrument_id"];
            isOneToOne: false;
            referencedRelation: "bs_debt_instruments";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "bs_investor_transactions_investor_id_fkey";
            columns: ["investor_id"];
            isOneToOne: false;
            referencedRelation: "contact";
            referencedColumns: ["id"];
      ...
      bs_investor_transactions_references: {
        Row: {
          id: number;
        ...
        Relationships: [
          {
            foreignKeyName: "transaction_references_transaction_id_fkey";
            columns: ["transaction_id"];
            isOneToOne: false;
            referencedRelation: "bs_investor_transactions";
            referencedColumns: ["id"];
          }
        ];
      };
      ...
      custom_loan_fees: {
        Row: {
          created_at: string;
          deal_id: number;
          "fee category": Database["public"]["Enums"]["fee_type"] | null;
      ...
      loan_price: {
        ...
        Relationships: [
          {
            foreignKeyName: "loan_price_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: false;
            referencedRelation: "deal";
            referencedColumns: ["id"];
      ...
      loan_price_saved: {
        ...
        Relationships: [
          {
            foreignKeyName: "loan_price_saved_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: false;
            referencedRelation: "deal";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "loan_price_saved_loan_price_id_fkey";
            columns: ["loan_price_id"];
            isOneToOne: false;
            referencedRelation: "loan_price";
            referencedColumns: ["id"];
          }
        ];
      };
      loan_program_a: {
        ...
        Relationships: [
          {
            foreignKeyName: "loan_program_a_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: true;
            referencedRelation: "deal";
            referencedColumns: ["id"];
      ...
      loan_program_b: {
        ...
        Relationships: [
          {
            foreignKeyName: "loan_program_b_deal_id_fkey";
            columns: ["deal_id"];
            isOneToOne: true;
            referencedRelation: "deal";
            referencedColumns: ["id"];
      ...
      max_ltv: {
        Row: {
          ...
          program: Database["public"]["Enums"]["loan_program"];
      ...
      rate_adjustment: {
        Row: {
          citizenship: Database["public"]["Enums"]["citizenship"] | null;
          created_at: string | null;
          dscr_max: number | null;
          dscr_min: number | null;
          fico_max: number | null;
          fico_min: number | null;
          id: number;
          loan_amount_upb_max: number | null;
          loan_amount_upb_min: number | null;
          loan_structure:
            | Database["public"]["Enums"]["loan_structure_dscr"]
            | null;
          ltv_1: number | null;
          ...
          ltv_6: number | null;
          ltv_7: number | null;
          prepay_penalty: Database["public"]["Enums"]["ppp_structure"] | null;
          program: Database["public"]["Enums"]["loan_program"] | null;
          property_type: Database["public"]["Enums"]["property_type"] | null;
          short_term_rental: Database["public"]["Enums"]["yes_no"] | null;
          state: Database["public"]["Enums"]["us_states"] | null;
          transaction_type:
            | Database["public"]["Enums"]["transaction_type"]
            | null;
          updated_at: string | null;
          uw_exception: Database["public"]["Enums"]["yes_no"] | null;
        };
        Insert: {
          citizenship?: Database["public"]["Enums"]["citizenship"] | null;
          created_at?: string | null;
      ...
      user_profile: {
        Row: {
          ...
          clerk_role: Database["public"]["Enums"]["clerk_role"] | null;
          contact_id: number | null;
    ...
    Functions: {
      create_company_from_submission: {
        Args: { submission_data: Json };
        Returns: number;
      };
      create_company_member_from_submission: {
        Args: { submission_data: Json; index: number; company_id: number };
        Returns: number;
      };
      create_deal_from_submission: {
        Args:
          | { submission_data: Json; new_property_id: number }
          | {
              submission_data: Json;
              new_property_id: number;
              new_company_id: number;
              new_guarantor_id: number;
              new_contact_id: number;
              new_contact_2_id: number;
              new_contact_3_id: number;
              new_contact_4_id: number;
            };
        Returns: number;
      };
      ...
      create_submission_borrower: {
        Args: {
          ...
          cellphone: string;
          otherphone: string;
          citizenstatus: Database["public"]["Enums"]["citizenship"];
          ssn: string;
          dob: string;
          addstreet: string;
          addstreet2: string;
          addcity: string;
          addstate: Database["public"]["Enums"]["us_states_long"];
          addpostal: string;
          addcounty: string;
          addcountry: string;
          fico: number;
          ...
          flips: number;
          groundups: number;
          experience: Database["public"]["Enums"]["yes_no"];
        };
        Returns: number;
      };
      create_submission_contact: {
        Args: {
          fname: string;
          mname: string;
          lname: string;
      ...
      get_max_ltv: {
        Args: {
          in_loan_program: Database["public"]["Enums"]["loan_program"];
          in_fico_score: number;
          in_citizenship: Database["public"]["Enums"]["citizenship"];
          in_loan_amount: number;
          in_short_term_rental: Database["public"]["Enums"]["yes_no"];
          in_property_type: Database["public"]["Enums"]["property_type"];
          in_transaction_type: Database["public"]["Enums"]["transaction_type"];
        };
        Returns: number;
      };
      get_max_upb: {
        Args: {
          program: string;
          ltv_value: number;
          short_term_rental: Database["public"]["Enums"]["yes_no"];
          credit_score: number;
        };
        Returns: number;
      };
      ...
      get_qualifying_rent: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          rented: Database["public"]["Enums"]["yes_no"];
          gross_rent: number;
          fmr: number;
      ...
      get_qualifying_rent_by_property: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          transaction_type: Database["public"]["Enums"]["transaction_type"];
          property: number;
      ...
      get_rate_adjustment: {
        Args: {
          ...
          in_property_type: Database["public"]["Enums"]["property_type"];
          in_short_term_rental: Database["public"]["Enums"]["yes_no"];
          in_state: Database["public"]["Enums"]["us_states"];
          in_prepay_penalty: Database["public"]["Enums"]["ppp_structure"];
          in_citizenship: Database["public"]["Enums"]["citizenship"];
          in_loan_structure: Database["public"]["Enums"]["loan_structure_dscr"];
          in_transaction_type: Database["public"]["Enums"]["transaction_type"];
          in_uw_exception: Database["public"]["Enums"]["yes_no"];
          loan_upb: number;
          dscr: number;
        };
        Returns: number;
      ...
      max_ltv: {
        Args: {
          ...
          transaction_type: Database["public"]["Enums"]["transaction_type"];
          credit_score: number;
          citizenship: Database["public"]["Enums"]["citizenship"];
      ...
      prequal_borrower_type: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          borrower_type: Database["public"]["Enums"]["vesting_type"];
          state_code: Database["public"]["Enums"]["us_states"];
        };
        Returns: string;
      };
      prequal_citizenship: {
      ...
      prequal_first_time_homebuyer: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          transaction_type: Database["public"]["Enums"]["transaction_type"];
          first_time_buyer: Database["public"]["Enums"]["yes_no"];
        };
        Returns: string;
      };
      prequal_interest_rate_buy_down: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          interest_rate_buy_down: number;
          total_bpc: number;
        };
        Returns: string;
      };
      prequal_interest_rate_final: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
      ...
      prequal_interest_rate_floor_base: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          interest_rate_floor: number;
      ...
      prequal_loan_price: {
        Args: {
          ...
          loan_price: number;
          property_type: Database["public"]["Enums"]["property_type"];
          loan_structure: Database["public"]["Enums"]["loan_structure_dscr"];
        };
        Returns: string;
      };
      prequal_ltv: {
        Args: { ltv: number; max_ltv: number };
        Returns: string;
      };
      prequal_max_upb: {
        Args: { loan_amount: number; max_upb: number };
        Returns: string;
      };
      prequal_program: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          state: Database["public"]["Enums"]["us_states"];
        };
        Returns: string;
      };
      prequal_property_state: {
        Args: {
          program: Database["public"]["Enums"]["loan_program"];
          state_code: Database["public"]["Enums"]["us_states"];
        };
      ...
      update_credit_check_status: {
        Args: {
          p_id: number;
          p_status: Database["public"]["Enums"]["credit_check_status"];
        };
        Returns: Json;
      };
      update_guarantor_info: {
        Args: { deal_id: number; guarantor_id: number };
        Returns: undefined;
      };
      update_loan_price: {
        Args:
          ...
          | {
              program: Database["public"]["Enums"]["loan_program"];
              recordid: number;
              loan_price_id: number;
            };
        Returns: undefined;
      };
      update_program_a: {
        Args: { input_deal_id: number };
        Returns: undefined;
      };
      update_program_b: {
        Args: { input_deal_id: number };
    ...
    Enums: {
      ...
      property_type:
        ...
        | "Mixed Use 11+"
        | "Other";
      reference_type_enum: "federal_reference_number" | "imad" | "omad";
